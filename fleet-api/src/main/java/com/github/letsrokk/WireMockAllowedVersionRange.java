...
record WireMockAllowedVersionRange(List<BigInteger> lower, boolean includesLower,
    ...
    static WireMockAllowedVersionRange parse(String value) {
        ...
        return new WireMockAllowedVersionRange(lower, includesLower, upper, includesUpper);
    }

    boolean contains(WireMockVersion candidate) {
        List<BigInteger> version = List.of(BigInteger.valueOf(candidate.major()), BigInteger.valueOf(candidate.minor()),
                BigInteger.valueOf(candidate.patch()));
