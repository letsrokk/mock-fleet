...
help:
	...
	@echo "  make local-deploy [NAMESPACE=name] [LOGS=true] [DEV=true|api|proxy] [PORT_FORWARD=true] [MITMPROXY=false] [REBUILD=dash|api|proxy|mcp|mock-ops|all]"
